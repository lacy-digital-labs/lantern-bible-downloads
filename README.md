...
[Releases](../../releases/latest) is the whole of it. Each release carries one
ePub and seven PDF editions, uploaded automatically when the build repository
tags a version.

## What's in a release

| File | Page size | Layout | Pages |
| --- | --- | --- | --- |
| `lantern-bible.epub` | reflows to any screen | — | — |
| `lantern-compact-1col.pdf` | 105 × 140 mm | Single column | 3,291 |
| `lantern-tablet-1col.pdf` | 148 × 210 mm | Single column | 1,782 |
| `lantern-tablet-2col.pdf` | 148 × 210 mm | Two column | 1,338 |
| `lantern-tablet-note.pdf` | 148 × 210 mm | Annotation margin | 2,128 |
| `lantern-tabloid-1col.pdf` | 179 × 265 mm | Single column | 1,305 |
| `lantern-tabloid-2col.pdf` | 179 × 265 mm | Two column | 928 |
| `lantern-tabloid-note.pdf` | 179 × 265 mm | Annotation margin | 1,508 |
...
The typographic design, formatting, navigation structure and all supplementary
material prepared for this edition are dedicated to the public domain under
